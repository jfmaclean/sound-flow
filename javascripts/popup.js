...
var draw = function () {
  ...
  if (data) {
    for (var i in data.tabs) {
      ...
      icon = "<img class='icon' src='" + (data.tabs[i].tab.favIconUrl ? data.tabs[i].tab.favIconUrl : "../../assets/images/PA.png") + "'>";
      pin = "<img class='pin' src='../../assets/images/pin_icon.png' style='visibility:" + (i == data.pinned ? "visible" : "hidden") + ";'>";
      ...
      state_button = "<img class='state_button' src=" + (playing ? "'../../assets/images/pause_button.png'" : "'../../assets/images/play_button.png'") + ">";
      volume_button = "<img class='volume_button' src=" + (muted ?  "'../../assets/images/mute_button.png'" : "'../../assets/images/volume_button.png'") + ">";
